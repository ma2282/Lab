...
```sh
git init
git commit -m "Changes index.html git clone url command"
```
**Задание 4**. Дополните файл style.css. Индексируйте измененные файлы и выполните коммит.
```sh
git записать add .
git commit -m "Changes style.css table style in page"
```
...
```sh
git remote add origin https://github.com/ma2282/Lab.git
